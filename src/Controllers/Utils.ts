...
import { DEFAULT_PROFILE_IMAGE } from "../Utilities/Endpoints.js"

import { imagekit } from "../server.js"
...
export const uploadImage = async (
  imagePath: string,
  id: string
): Promise<UserI["profilePicture"] | null> => {
  try {
...
export const deleteImageFromImageKit = (FILE_ID: string): void => {
  if (
    ...
    imagekit.deleteFile(FILE_ID, err => {
